  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved welcome as @welcome" do
        ...
        post :create, {:welcome => { "index" => "invalid value" }}, valid_session
        assigns(:welcome).should be_a_new(Welcome)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested welcome" do
        ...
        Welcome.any_instance.should_receive(:update).with({ "index" => "MyString" })
        put :update, {:id => welcome.to_param, :welcome => { "index" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the welcome as @welcome" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Welcome.any_instance.stub(:save).and_return(false)
        put :update, {:id => welcome.to_param, :welcome => { "index" => "invalid value" }}, valid_session
        assigns(:welcome).should eq(welcome)
      end
